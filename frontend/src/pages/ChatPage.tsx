      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="border-b border-wine-800/30 px-6 py-4 flex items-center justify-between bg-wine-950/40 backdrop-blur-sm">
          <div>
            ...
            <p className="font-body italic text-wine-200 text-sm">Ask anything about wine</p>
          </div>
          <div className="flex items-center gap-2 text-wine-200 text-xs font-sans">
        ...
        <div className="flex-1 overflow-y-auto px-6 py-6">
          {messages.length === 0 && (
            ...
            >
              ...
              <h2 className="font-display text-2xl text-wine-300 mb-2">Welcome to your cellar</h2>
              <p className="font-body italic text-wine-200 max-w-sm">
          ...
          {isLoading && (
            <motion.div
              ...
              exit={{ opacity: 0 }}
              className="flex items-center gap-2 text-wine-200 text-sm font-sans mb-4"
            >
